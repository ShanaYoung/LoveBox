//
//  DeleteRecordingViewController.m
//  恋爱储蓄
//
...
@interface DeleteRecordingViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    UITableView *myTableView;
}
@end

@implementation DeleteRecordingViewController
